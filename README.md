...
- If ChatGPT accepts the prompt but response capture later fails, ReviewGPT exits nonzero while preserving the canonical thread URL. Inspect or resume that thread before retrying so the same review is not sent twice.
