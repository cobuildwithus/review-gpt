...
- Waited runs that request a concrete model add a `MODEL_CONFIRMATION: <model>` contract to the prompt and fail capture if the final response omits it, reports `UNKNOWN`, or confirms a different model.
