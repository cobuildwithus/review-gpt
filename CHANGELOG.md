...
### Fixed
- bound long-lived CDP command state

## [0.5.141] - 2026-08-31

### Fixed
- accept live Sol response slug
...
### Fixed
- validate declared patch artifacts
...
### Fixed
- retry transient ChatGPT auth (#4)

## [0.5.136] - 2026-08-20

### Fixed
- accept advertised negative flags
...
### Fixed
- canonicalize nested ChatGPT turn aliases
...
### Fixed
- harden review response attestation
...
### Added
- default review context to codebase zip

## [0.5.101] - 2026-07-10

### Fixed
- require explicit model confirmation
...
### Fixed
- handle updated ChatGPT model picker
...
### Fixed
- keep background automation on existing targets
...
### Fixed
- reload stale same-thread snapshots
...
### Added
- surface autosend thread ids

## [0.5.44] - 2026-04-06

### Fixed
- harvest assistant artifacts
...
### Fixed
- wait for real conversation content after reload
...
### Fixed
- harden thread download fallback
